...
class MapNode
{
	...
	public void setDistanceToSource(double newDist) {
		this.distanceToSource = newDist;
	}
	
	public double getAStarDistance() {
		return this.aStarDist;
	}
	public void setAStarDistance(double newDist) {
		this.aStarDist = newDist;
	}
